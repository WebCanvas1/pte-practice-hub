/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bf51746497a3ca50908fe8b2384d63b2)
...
interface __BaseEnv_Env {
	...
	MEDIA: R2Bucket;
	DB: D1Database;
	CONTENT_IMPORT_QUEUE?: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	APP_ENV: "preview" | "production" | "local";
	APP_URL: "https://pte-practice-hub-preview.workers.dev" | "https://pte-practice-hub.webstarter17.workers.dev" | "http://localhost:5173";
	SUPPORT_EMAIL: "support@example.com";
	AI_WRITING_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	AI_SPEAKING_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	AI_TRANSCRIPTION_MODEL: "@cf/openai/whisper-large-v3-turbo";
	CONTENT_IMPORT_WORKFLOW?: Workflow /* ContentImportWorkflow */;
}
declare namespace Cloudflare {
	interface PreviewEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "preview";
		APP_URL: "https://pte-practice-hub-preview.workers.dev";
		SUPPORT_EMAIL: "support@example.com";
		AI_WRITING_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
		AI_SPEAKING_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
		AI_TRANSCRIPTION_MODEL: "@cf/openai/whisper-large-v3-turbo";
	...
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "production";
		APP_URL: "https://pte-practice-hub.webstarter17.workers.dev";
		SUPPORT_EMAIL: "support@example.com";
		AI_WRITING_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
		AI_SPEAKING_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
		AI_TRANSCRIPTION_MODEL: "@cf/openai/whisper-large-v3-turbo";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_URL" | "SUPPORT_EMAIL" | "AI_WRITING_MODEL" | "AI_SPEAKING_MODEL" | "AI_TRANSCRIPTION_MODEL">> {}
}
